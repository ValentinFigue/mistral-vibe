...
# scikit-learn (analyst ML operators) is a base dependency and lazy-imported at runtime, so it must
# be bundled explicitly. It is always installed, so bundle unconditionally.
